...
D\'{e}veloppement de SmartYield3 : une technologie logicielle de contr\^{o}le des processus qui permet aux clients d'acc\'{e}l\'{e}rer la conception des processus et d'augmenter le rendement de la production gr\^{a}ce à une technologie unique d'apprentissage profond.\\}
&
